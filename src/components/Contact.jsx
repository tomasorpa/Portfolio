const Contact = () => {
  const socialLinks = [
    {
      href: "https://github.com/tomasorpa",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.linkedin.com/in/tomasortegap/",
      icon: (
        <svg
          width="24"
          height="24"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            Ready to Join Your company
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Eager to bring my skills and enthusiasm to contribute to your team’s
            success. Reach me out !
          </p>
        ...
        <form
          action="https://getform.io/f/aejjqemb"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="Tomasorpa@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
